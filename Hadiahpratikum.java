...
import java.awt.event.*;
   ...
   public abstract class Hadiahpratikum implements ActionListener{
       private static void createAndShowGUI() {
           JFrame frame = new JFrame("Menu Pilihan"); frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      ...
      {
          lebel.setText(" Devi Chungiarto");
          lebel2.setText("51017006");
          lebel3.setText("Kandea 2 Lr. 116");
      }
